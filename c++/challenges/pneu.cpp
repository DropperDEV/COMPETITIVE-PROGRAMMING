...
// A primeira linha da entrada contém um inteiro NN que indica a pressão desejada pelo motorista (1≤N≤401≤N≤40). A segunda linha contém um inteiro MM que indica a pressão lida pela bomba (1≤M≤401≤M≤40).
// Saída
