...
int main(){
    ...
    if(A == 1 and B == 0 and C == 0) cout << 'A' << '\n';
    if(A == 0 and B == 1 and C == 1) cout << 'A' << '\n';

    if(A == 0 and B == 1 and C == 0) cout << 'B' << '\n';
    if(A == 1 and B == 0 and C == 1) cout << 'B' << '\n';

    if(A == 0 and B == 0 and C == 1) cout << 'C' << '\n';
    if(A == 1 and B == 1 and C == 0) cout << 'C' << '\n';

    if(A == B and B == C and C == A) cout << '*' << '\n';
